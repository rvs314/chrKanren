...
#+begin_quote
This work was recently presented at the International Conference on Logic Programming (ICLP 2026). See [[https://dx.doi.org/10.4204/EPTCS.450.30][the paper which presented it]].
#+end_quote
